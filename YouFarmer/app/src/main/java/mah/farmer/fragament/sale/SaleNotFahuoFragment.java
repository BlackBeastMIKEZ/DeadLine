 ...
 */
public class SaleNotFahuoFragment extends Fragment {
    ...
    public SaleNotFahuoFragment(Context ctx) {
        super();
        this.ctx = ctx;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = null;
        view = View.inflate(ctx, R.layout.fragment_sale_notfahuo, null);
        return view;
    }
    ...
    public void initView() {
        circleRefreshLayout= (CircleRefreshLayout) getActivity().findViewById(R.id.sale_not_fahuo_refresh_layout);
        data=new ArrayList<>();
        listView= (ListView) getActivity().findViewById(R.id.sale_not_fahuo_supply_list);
        getNotFahuodata();
        ...
        JsonObjectRequest jsonObjectRequest=new JsonObjectRequest(Request.Method.POST,"http://192.168.235.22:8080/showSaleOrder/",
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                try {
                    ...
                    Toast.makeText(getActivity(), "获取订单" + jsonObject.getString("reason"), Toast.LENGTH_LONG).show();
