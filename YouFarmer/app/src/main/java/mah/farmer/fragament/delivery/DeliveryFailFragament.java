 ...
 */
public class DeliveryFailFragament extends Fragment {
    ...
    public DeliveryFailFragament(Context ctx) {
        super();
        this.ctx = ctx;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = null;
        view = View.inflate(ctx, R.layout.fragment_delivery_fail, null);
        return view;
    }
    ...
    public void initView() {
        ...
        circleRefreshLayout= (CircleRefreshLayout) getActivity().findViewById(R.id.delivery_fail_refresh_layout);
        data=new ArrayList<>();
        listView= (ListView) getActivity().findViewById(R.id.delivery_fail_supply_list);
