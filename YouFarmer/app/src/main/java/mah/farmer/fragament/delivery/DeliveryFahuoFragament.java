 ...
 */
public class DeliveryFahuoFragament extends Fragment{
    ...
    public DeliveryFahuoFragament(Context ctx) {
        super();
        this.ctx = ctx;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = null;
        view = View.inflate(ctx, R.layout.fragment_delivery_fahuo, null);
        return view;
    }
    ...
    public void initView() {
        circleRefreshLayout= (CircleRefreshLayout) getActivity().findViewById(R.id.delivery_fahuo_refresh_layout);
        data=new ArrayList<>();
        listView= (ListView) getActivity().findViewById(R.id.delivery_fahuo_supply_list);
        deliveryAdapter=new DeliveryAdapter(getActivity(),data);
        listView.setAdapter(deliveryAdapter);
        layout_all= (LinearLayout) getActivity().findViewById(R.id.layout_fahuo_all);
        if(data.size()==0){
