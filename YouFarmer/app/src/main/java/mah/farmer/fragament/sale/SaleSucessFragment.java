 ...
 */
public class SaleSucessFragment extends Fragment {
    ...
    public SaleSucessFragment(Context ctx) {
        super();
        this.ctx = ctx;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = null;
        view = View.inflate(ctx, R.layout.fragment_sale_sucess, null);
        return view;
    }
    ...
    public void initView() {
        circleRefreshLayout= (CircleRefreshLayout) getActivity().findViewById(R.id.sale_success_refresh_layout);
        data=new ArrayList<>();
        listView= (ListView) getActivity().findViewById(R.id.sale_success_supply_list);
