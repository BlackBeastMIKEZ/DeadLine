 ...
 */
public class SaleFahuoFragment extends Fragment {
    ...
    public SaleFahuoFragment(Context ctx) {
        super();
        this.ctx = ctx;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = null;
        view = View.inflate(ctx, R.layout.fragment_sale_fahuo, null);
        return view;
    }
    ...
    public void initView() {
        circleRefreshLayout= (CircleRefreshLayout) getActivity().findViewById(R.id.sale_fahuo_refresh_layout);
        data=new ArrayList<>();
        listView= (ListView) getActivity().findViewById(R.id.sale_fahuo_supply_list);
