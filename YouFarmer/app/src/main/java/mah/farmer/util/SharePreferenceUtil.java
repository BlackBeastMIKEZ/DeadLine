...
public class SharePreferenceUtil {
    ...
    private String SHARED_KEY_FLOAT="shared_key_float";
    ...
    public boolean isAllowFloat() {
        return mSharedPreferences.getBoolean(SHARED_KEY_FLOAT, true);
    }

    public void setFloatEnable(boolean isChecked) {
        editor.putBoolean(SHARED_KEY_FLOAT, isChecked);
        editor.commit();
    }
